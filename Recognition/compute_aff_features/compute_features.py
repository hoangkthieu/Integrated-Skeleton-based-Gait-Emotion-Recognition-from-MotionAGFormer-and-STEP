...
# avoid name collision with HRNet's utils package by using full module path
from compute_aff_features.utils import angle_between, distance_between, area_triangle
...
def compute_features(frames, time_step, add_stride_features=True):
    features = [
        # Volume
